...
class Ui_RegisterDialog(object):
    def setupUi(self, RegisterDialog):
        ...
        # Thay thế QLabel bằng QPushButton cho dòng "Bạn đã có tài khoản? Đăng nhập"
        self.alreadyHaveAccountButton = QtWidgets.QPushButton(self.rightPanel)
        self.alreadyHaveAccountButton.setGeometry(QtCore.QRect(50, 450, 300, 25))
        self.alreadyHaveAccountButton.setStyleSheet("color: #007BFF; text-decoration: underline; border: none;")
        self.alreadyHaveAccountButton.setText("Bạn đã có tài khoản? Đăng nhập")
